...
I finalized Caffeinated today with only a couple of minor changes, so it's now available for anyone to build and run on [GitHub](https://github.com/lauderbaugh/Caffeinated).
